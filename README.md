...
* `spec`: contains the IP pool configuration
  ...
  * `nodeSelector`: A list of node selector terms. The terms are ORed. Only the nodes that match the provided labels will get assigned IP Blocks for the defined pool.
